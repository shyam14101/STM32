...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  int lastbtn = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_0);
	  int lastbtn1 = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_1);

	  if(lastbtn == GPIO_PIN_SET){
		  a++;
